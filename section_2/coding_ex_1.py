...
which is a list of comment models. The model should have:
An author, which is a string
The comment, which is a string
Likes, which is an integer

Practice creating a social media post with whatever data you like,
...
post = Post(
    ...
    id=42,
    likes=["6"],
    comments=[Comment(author="bob", comment="comment body", likes=3)],
)
